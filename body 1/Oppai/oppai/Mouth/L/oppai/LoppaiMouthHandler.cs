...
// IEndDragHandler を追加します
public class LoppaiMouthHandler : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [Header("変化させるスクリプトがあるオブジェクト")]
    public LoppaiMouthChange spriteChanger;
    [Header("ゲージの増減させるオブジェクト")]
